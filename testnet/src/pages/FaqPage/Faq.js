  ...
  return (
    ...
    <div className="faq_cont_inn">
      <div className="faq_hd">
        <p>
          <i className="uil uil-question-circle"></i> Frequently Asked Questions
        </p>
      </div>
      ...
      {[
        ...
        },
        {
          ...
          que: "What is Tita?",
          ans: "Tita is Choice Coin Payment Gateway For ASA Governance And Checking Governance Scheduling Dates",
        },
        {
          que: "Is Choice Coin on any listing or DEX",
          ans : "Choice Coin is on Coin Market Cap, Live Coin Watch, Coin Gecko, Tinyman, AlgoFi etc."
        }
      ].map((item, i) => (
        ...
        <button className="ask_que">
          <p>
            <a style={{
             ...
             href = "https://discord.gg/YNAbfB4WEy">Ask a question or contribute by joining our Discord</a>{" "}
